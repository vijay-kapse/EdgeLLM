...
> Status: **Phase 1 complete** (model loading + baseline PyTorch generation). Phases 2–8 in progress.
...
| Precision | Size (MB) | Latency (s) | Throughput (tok/s) | Peak RAM (MB) | Perplexity |
| --- | --- | --- | --- | --- | --- |
| FP32 (PyTorch) | _TODO(vijay): Phase 2_ | _TODO_ | _TODO_ | _TODO_ | _TODO_ |
| INT8 (ONNX Runtime) | _TODO(vijay): Phase 3_ | _TODO_ | _TODO_ | _TODO_ | _TODO_ |
| INT4 (GPTQ/AWQ) | _TODO(vijay): Phase 3_ | _TODO_ | _TODO_ | _TODO_ | _TODO_ |
| INT8 on Snapdragon NPU | _TODO(vijay): run on Snapdragon (Phase 5)_ | _TODO_ | _TODO_ | _TODO_ | _TODO_ |
